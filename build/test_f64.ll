...
entry:
  %local.v.0 = alloca i64
  %local.i.1 = alloca i64
  %local.n = alloca i64
  store i64 %n, ptr %local.n
  %local.val = alloca i64
  store i64 %val, ptr %local.val
  %t2 = call ptr @intrinsic_vec_new()
  %t3 = ptrtoint ptr %t2 to i64
  store i64 %t3, ptr %local.v.0
  store i64 0, ptr %local.i.1
  br label %loop0
loop0:
  %t4 = load i64, ptr %local.i.1
  %t5 = load i64, ptr %local.n
  %t6 = icmp slt i64 %t4, %t5
  %t7 = zext i1 %t6 to i64
  %t8 = icmp ne i64 %t7, 0
  br i1 %t8, label %body0, label %endloop0
body0:
  %t9 = load i64, ptr %local.v.0
  %t10 = load i64, ptr %local.val
  %t11 = inttoptr i64 %t9 to ptr
  %t12 = inttoptr i64 %t10 to ptr
  call void @intrinsic_vec_push(ptr %t11, ptr %t12)
  %t13 = load i64, ptr %local.i.1
  %t14 = add i64 %t13, 1
  store i64 %t14, ptr %local.i.1
  br label %loop0
endloop0:
  %t15 = load i64, ptr %local.v.0
  ret i64 %t15
}
...
entry:
  ...
  %local.w.17 = alloca i64
  %local.target.18 = alloca i64
  %local.lr.19 = alloca i64
  %local.step.20 = alloca i64
  %local.i.21 = alloca i64
  %local.wi.22 = alloca i64
  %local.ti.23 = alloca i64
  %local.grad.24 = alloca i64
  %local.new_wi.25 = alloca i64
  %local.j.26 = alloca i64
  %local.wj.27 = alloca i64
  %local.tj.28 = alloca i64
  %local.dj.29 = alloca i64
  %local.dsq.30 = alloca i64
  store i64 8, ptr %local.n.16
  %t31 = load i64, ptr %local.n.16
  %t32 = call i64 @f64_parse(ptr @.str.test_f64.0)
  %t33 = call i64 @"vfill"(i64 %t31, i64 %t32)
  store i64 %t33, ptr %local.w.17
  %t34 = load i64, ptr %local.n.16
  %t35 = call i64 @f64_parse(ptr @.str.test_f64.1)
  %t36 = call i64 @"vfill"(i64 %t34, i64 %t35)
  store i64 %t36, ptr %local.target.18
  %t37 = call i64 @f64_parse(ptr @.str.test_f64.2)
  store i64 %t37, ptr %local.lr.19
  store i64 0, ptr %local.step.20
  br label %loop1
loop1:
  %t38 = load i64, ptr %local.step.20
  %t39 = icmp slt i64 %t38, 500
  %t40 = zext i1 %t39 to i64
  %t41 = icmp ne i64 %t40, 0
  br i1 %t41, label %body1, label %endloop1
body1:
  store i64 0, ptr %local.i.21
  br label %loop2
loop2:
  %t42 = load i64, ptr %local.i.21
  %t43 = load i64, ptr %local.n.16
  %t44 = icmp slt i64 %t42, %t43
  %t45 = zext i1 %t44 to i64
  %t46 = icmp ne i64 %t45, 0
  br i1 %t46, label %body2, label %endloop2
body2:
  %t47 = load i64, ptr %local.w.17
  %t48 = load i64, ptr %local.i.21
  %t49 = inttoptr i64 %t47 to ptr
  %t50 = call ptr @intrinsic_vec_get(ptr %t49, i64 %t48)
  %t51 = ptrtoint ptr %t50 to i64
  store i64 %t51, ptr %local.wi.22
  %t52 = load i64, ptr %local.target.18
  %t53 = load i64, ptr %local.i.21
  %t54 = inttoptr i64 %t52 to ptr
  %t55 = call ptr @intrinsic_vec_get(ptr %t54, i64 %t53)
  %t56 = ptrtoint ptr %t55 to i64
  store i64 %t56, ptr %local.ti.23
  %t57 = call i64 @f64_parse(ptr @.str.test_f64.3)
  %t58 = load i64, ptr %local.wi.22
  %t59 = load i64, ptr %local.ti.23
  %t60 = call i64 @"sx_f64_sub"(i64 %t58, i64 %t59)
  %t61 = call i64 @"sx_f64_mul"(i64 %t57, i64 %t60)
  store i64 %t61, ptr %local.grad.24
  %t62 = load i64, ptr %local.wi.22
  %t63 = load i64, ptr %local.lr.19
  %t64 = load i64, ptr %local.grad.24
  %t65 = call i64 @"sx_f64_mul"(i64 %t63, i64 %t64)
  %t66 = call i64 @"sx_f64_sub"(i64 %t62, i64 %t65)
  store i64 %t66, ptr %local.new_wi.25
  %t67 = load i64, ptr %local.w.17
  %t68 = load i64, ptr %local.i.21
  %t69 = load i64, ptr %local.new_wi.25
  %t70 = inttoptr i64 %t67 to ptr
  %t71 = inttoptr i64 %t69 to ptr
  call void @intrinsic_vec_set(ptr %t70, i64 %t68, ptr %t71)
  %t72 = load i64, ptr %local.i.21
  %t73 = add i64 %t72, 1
  store i64 %t73, ptr %local.i.21
  br label %loop2
endloop2:
  %t74 = load i64, ptr %local.step.20
  %t75 = add i64 %t74, 1
  store i64 %t75, ptr %local.step.20
  br label %loop1
endloop1:
  store i64 0, ptr %local.j.26
  br label %loop3
loop3:
  %t76 = load i64, ptr %local.j.26
  %t77 = load i64, ptr %local.n.16
  %t78 = icmp slt i64 %t76, %t77
  %t79 = zext i1 %t78 to i64
  %t80 = icmp ne i64 %t79, 0
  br i1 %t80, label %body3, label %endloop3
body3:
  %t81 = load i64, ptr %local.w.17
  %t82 = load i64, ptr %local.j.26
  %t83 = inttoptr i64 %t81 to ptr
  %t84 = call ptr @intrinsic_vec_get(ptr %t83, i64 %t82)
  %t85 = ptrtoint ptr %t84 to i64
  store i64 %t85, ptr %local.wj.27
  %t86 = load i64, ptr %local.target.18
  %t87 = load i64, ptr %local.j.26
  %t88 = inttoptr i64 %t86 to ptr
  %t89 = call ptr @intrinsic_vec_get(ptr %t88, i64 %t87)
  %t90 = ptrtoint ptr %t89 to i64
  store i64 %t90, ptr %local.tj.28
  %t91 = load i64, ptr %local.wj.27
  %t92 = load i64, ptr %local.tj.28
  %t93 = call i64 @"sx_f64_sub"(i64 %t91, i64 %t92)
  store i64 %t93, ptr %local.dj.29
  %t94 = load i64, ptr %local.dj.29
  %t95 = load i64, ptr %local.dj.29
  %t96 = call i64 @"sx_f64_mul"(i64 %t94, i64 %t95)
  store i64 %t96, ptr %local.dsq.30
  %t97 = call ptr @intrinsic_string_new(ptr @.str.test_f64.4)
  %t98 = ptrtoint ptr %t97 to i64
  %t99 = inttoptr i64 %t98 to ptr
  call void @intrinsic_print(ptr %t99)
  %t100 = load i64, ptr %local.j.26
  call void @print_i64(i64 %t100)
  %t101 = call ptr @intrinsic_string_new(ptr @.str.test_f64.5)
  %t102 = ptrtoint ptr %t101 to i64
  %t103 = inttoptr i64 %t102 to ptr
  call void @intrinsic_print(ptr %t103)
  %t104 = load i64, ptr %local.wj.27
  %t105 = call i64 @"print_f64"(i64 %t104)
  %t106 = call ptr @intrinsic_string_new(ptr @.str.test_f64.6)
  %t107 = ptrtoint ptr %t106 to i64
  %t108 = inttoptr i64 %t107 to ptr
  call void @intrinsic_print(ptr %t108)
  %t109 = load i64, ptr %local.tj.28
  %t110 = call i64 @"print_f64"(i64 %t109)
  %t111 = call ptr @intrinsic_string_new(ptr @.str.test_f64.7)
  %t112 = ptrtoint ptr %t111 to i64
  %t113 = inttoptr i64 %t112 to ptr
  call void @intrinsic_print(ptr %t113)
  %t114 = load i64, ptr %local.dsq.30
  %t115 = call i64 @"print_f64"(i64 %t114)
  %t116 = call ptr @intrinsic_string_new(ptr @.str.test_f64.8)
  %t117 = ptrtoint ptr %t116 to i64
  %t118 = inttoptr i64 %t117 to ptr
  call void @intrinsic_println(ptr %t118)
  %t119 = load i64, ptr %local.j.26
  %t120 = add i64 %t119, 1
  store i64 %t120, ptr %local.j.26
  br label %loop3
endloop3:
  ret i64 0
}
...
; String constants
@.str.test_f64.0 = private unnamed_addr constant [4 x i8] c"0.0\00"
@.str.test_f64.1 = private unnamed_addr constant [4 x i8] c"3.0\00"
@.str.test_f64.2 = private unnamed_addr constant [6 x i8] c"0.001\00"
@.str.test_f64.3 = private unnamed_addr constant [4 x i8] c"2.0\00"
@.str.test_f64.4 = private unnamed_addr constant [3 x i8] c"j=\00"
@.str.test_f64.5 = private unnamed_addr constant [4 x i8] c" w=\00"
@.str.test_f64.6 = private unnamed_addr constant [4 x i8] c" t=\00"
@.str.test_f64.7 = private unnamed_addr constant [6 x i8] c" d^2=\00"
@.str.test_f64.8 = private unnamed_addr constant [1 x i8] c"\00"
