...
/* Get imaginary part of state (for physical-space reconstruction) */
int64_t c3d_get_state_ux_im(int64_t idx) { return dbl_to_bits(state_data[6*(int)idx+1]); }
int64_t c3d_get_state_uy_im(int64_t idx) { return dbl_to_bits(state_data[6*(int)idx+3]); }
int64_t c3d_get_state_uz_im(int64_t idx) { return dbl_to_bits(state_data[6*(int)idx+5]); }
